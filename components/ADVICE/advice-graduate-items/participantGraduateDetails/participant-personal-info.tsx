...
export default function ParticipantPrimaryInfo({
  ...
  // Parse birthDate safely, handling undefined or incorrect formats
      ...
      <div className="flex gap-4 mt-2">
        ...
        <div className="relative grid w-full items-center gap-1.5">
          ...
          <div className="relative">
            <Input readOnly value={participant.dniImage?.split("/").pop() ?? ""} className="pr-10" />
        ...
        <div className="grid w-full items-center gap-1.5">
          ...
          <div className="relative">
            <Input readOnly value={participant.form?.split("/").pop() ?? ""} className="pr-10" />
        ...
        <div className="grid w-full items-center gap-1.5">
          ...
          <div className="relative">
            <Input readOnly value={participant.imageTitle?.split("/").pop() ?? ""} className="pr-10" />
